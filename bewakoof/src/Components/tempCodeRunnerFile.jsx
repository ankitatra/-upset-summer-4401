     ...
     <div className={f.container}>
            <div className={f.main_container}>
                ...
                <div className={list_container}>
                    ...
                    <div>
                        <ul>
                            <li className={last_column}>FANBOOK</li>
                            <li className={last_column}>OFFERS</li>
                            <li className={last_column}>SITEMAP</li>
                        </ul>
                    </div>
